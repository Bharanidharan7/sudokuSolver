...
private:
	...
	{
		cout << "\nPlease start inputting the values...\n";
...
public:
	~Possibilities()
	{
		destroy(); // This destructor destroys the linked list once the object has finished operation.
	}
...
public:
	...
	{ // we need toclear the old list if any exists
